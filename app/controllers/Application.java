...
public class Application extends Controller {
    ...
    public static void enregistrerNouveauClient(@Required String nom, @Required String prenom, @Required @Email String email, @Required String motDePasse, String role, boolean isSupprime) throws Throwable {
        ...
        try {
            ...
            ClientService.get().modifier(client, nom, prenom, null, null, role, isSupprime);
